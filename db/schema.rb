...
ActiveRecord::Schema.define(version: 2022_08_06_073422) do
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.integer "cart", default: 0, null: false
    t.integer "caddy", default: 0, null: false
  ...
  create_table "reserves", force: :cascade do |t|
    ...
    t.integer "reserves_status", default: 0, null: false
    t.datetime "start"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
